...
var g = (function(gamma) {
    ...
    gamma.plugins = [
        ...
        },
        {
            ...
            "details":"Issues integration plugin for Embold."
        },
        {
            "name": "Tasks",
            "id": "tasks",
            ...
            "details":"Tasks integration plugin for Embold."
        },
        {
            "name": "Partitions",
            "id": "partitions",
            ...
            "details":"Partitions integration plugin for Embold."
        },
        {
    ...
    gamma.method_level_antipattern_colors = { 'BM': '#aa5766', 'DC': '#a6987d', 'FE': '#dcbca6', 'IC': '#d68e6e', 'SS': '#f7e380', 'CSS': '#7bab84',
                                             'CSW': '#c9bb72', 'CSI': '#eb9244', 'TH': '#aeb1bd', 'DE': '#96CFEC', 'MC': '#8DD6A0', 'FO': '#E59A96',
                                              'DCL': '#4C93BD', 'UM':'#78D4D0','GV':'#D8986C','CF':'#80cec4','CC':'#c69ac7','NF':'#80cec4','NC':'#c69ac7','DVD':'#F7E172','PA':'#72CEE3','JSH':'#F3AD7D'};
    ...
    gamma.context_register = {
        ...
        "subsystems" :
        {
            "plugins":
            {
                ...
                "repository_trends": { "required_snapshot": 1, "max_snapshot": 1, "resetBreadcrumb": true, "createNewInstance": true, "pluginOptions": true, "resetFilters": false, "showPlugin": true, "showSnapshotPanel": false, "pluginIcon": "ic-trends"},
